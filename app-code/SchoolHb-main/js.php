    ...
    <div class="row text-center ">
      ...
      <div class="col-lg-6 col-md-6 mb-4">
        <div class="card h-100 hoverable">
          ...
          <div class="card-footer">
            <a href="js_course_1.php" class="btn blue-gradient"><i class="fas fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;المزيد</a>
            <a href="js_course_1.php" class="btn red" style="color:white;" ><i class="fab fa-youtube"></i>&nbsp;&nbsp;YouTube</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 mb-4">
        <div class="card h-100 hoverable">
          ...
          <div class="card-footer">
            <a href="js_course_2.php" class="btn blue-gradient"><i class="fas fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;المزيد</a>
            <a href="js_course_2.php" class="btn red" style="color:white;" ><i class="fab fa-youtube"></i>&nbsp;&nbsp;YouTube</a>
          </div>
        </div>
      </div>
