    ...
    <div class="row text-center ">
      ...
      <div class="col-lg-6 col-md-6 mb-4">
        <div class="card h-100 hoverable">
          ...
          <img class="card-img-top" src="img/20200817_200022.jpg" alt="">
               <a>
          ...
          <div class="card-body">
            ...
            <p class="card-text" style="font-size: 18px">Please Wait ...</p>
          </div>
          <div class="card-footer">
            <a href="bootstrap_course_1.php" class="btn blue-gradient"><i class="fas fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;المزيد</a>
            <a href="bootstrap_course_1.php" class="btn red" style="color:white;" ><i class="fab fa-youtube"></i>&nbsp;&nbsp;YouTube</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 mb-4">
        <div class="card h-100 hoverable">
            <div class="view overlay"> 
          <img class="card-img-top" src="img/20200817_200325.jpg" alt="">
               <a>
          <div class="mask rgba-white-slight waves-effect waves-light"></div>
                </a>
            </div>
          ...
          <div class="card-footer">
            <a href="bootstrap_course_2.php" class="btn blue-gradient"><i class="fas fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;المزيد</a>
            <a href="bootstrap_course_2.php" class="btn red" style="color:white;" ><i class="fab fa-youtube"></i>&nbsp;&nbsp;YouTube</a>
          </div>
        </div>
      </div>
